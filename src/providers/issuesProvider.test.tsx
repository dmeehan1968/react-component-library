...
describe('sortByTimestampDesc', () => {
  it('sorts timestamps (Date) descending', () => {
    const issues: Issue[] = [
      ...
      { id: '2', title: 'b', url: '', project: 'p', description: '', timestamp: new Date('2025-02-01T00:00:00.000Z'), inputTokens: 0, outputTokens: 0, cacheTokens: 0, cost: 0, time: 0, status: 'queued' },
      { id: '3', title: 'c', url: '', project: 'p', description: '', timestamp: new Date('2024-12-31T23:59:59.000Z'), inputTokens: 0, outputTokens: 0, cacheTokens: 0, cost: 0, time: 0, status: 'queued' },
    ]
